...
<html lang="es">
    ...
    <body>
        ...
        <div class="container" style="background: #fff;">
            <div class="span8">
                ...
                {if Session::get('mensaje')}
                    <div id="_msg" class="alert alert-success">
                        <a class="close" data-dismiss="alert">x</a>
                        {Session::get('mensaje')}
                        {Session::destroy(array('mensaje'))}
                    </div>
                {/if}
        ...
        <div class="navbar navbar-fixed-bottom">
            <div class="navbar-inner">
                <div class="container">
                    <div style="margin-top: 10px; text-align: center;">Copyright&copy; 2012 <a href="http://www.nelsonmr.byethost32.com" target="_blank">www.nelsonmr.byethost32.com</a></div>
                </div>
            </div>
        </div>
