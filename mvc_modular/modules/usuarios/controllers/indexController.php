...
class indexController extends usuariosController
{
    ...
    public function index() 
    {
        ...
        $this->_view->assign('usuarios', $this->_usuarios->getUsuarios()); // Enviamos los usuarios    
        $this->_view->renderizar('index');
    }
    
    public function permisos($usuarioID) 
    {
        $id = $this->filtraInt($usuarioID);
        ...
        $this->_view->assign('role', $permisosRole); // Enviamos los usuarios
